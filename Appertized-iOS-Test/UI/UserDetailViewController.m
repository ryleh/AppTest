...
-(void)showUserDetails
{
    ...
    self.name.text = [self.user valueForKey:@"name"];
    self.gender.text = [self.user valueForKey:@"gender"];
    self.email.text = [self.user valueForKey:@"email"];
    self.phone.text = [self.user valueForKey:@"phone"];
